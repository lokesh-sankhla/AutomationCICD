...
public class BaseTest {
	...
	public WebDriver initializedDriver() throws IOException {
		...
		if (browserName.contains("chrome")) {
		    ...
		    if (browserName.contains("headless")) {
		        System.out.println("*******************************headless browser chrome*****************************************");
		        options.addArguments("--headless"); // Correct argument for headless mode
		        options.addArguments("--window-size=1440,900"); // Set window size in headless mode
		    }
	...
	public List<HashMap<String, String>> getJasonDataToMap(String FilePath) throws IOException {
	    ...
	    String jsonContent = FileUtils.readFileToString(
	            new File(FilePath), 
	            StandardCharsets.UTF_8 // Specify character encoding
	    );
